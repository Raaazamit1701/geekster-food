                        ...
                        <div className=" m-3">
                           {
                             e.quotes.map(qote => {
                                ...
                                return(
                                    <div className=" m-7">
                                        <blockquote className="rounded-xl bg-gray-50  shadow text-2xl  font-semibold text-center p-6">
                                        <p className="leading-relaxed text-gray-700">
                                            {qote.quote}
                                        </p>
                                        <p className=" p-3  text-xl text-center font-normal"> Author : {qote.author}</p>
                                    </blockquote>
                                    </div>
                                )
                             })
